...
import { Zap, Eye, EyeOff, AlertCircle, Check, Github, Twitter } from 'lucide-react'
      ...
      <div className="section-padding w-full max-w-md">
        <div className="glass-card p-8 lg:p-10">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400">Start building with powerful APIs today</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="mt-3 space-y-1">
                {passwordRequirements.map((req, i) => (
                  <div key={i} className={`flex items-center gap-2 text-xs ${req.met ? 'text-accent-green' : 'text-gray-500'}`}>
            ...
            <label className="flex items-start gap-3 cursor-pointer">
              <input
                ...
                className="w-4 h-4 mt-0.5 rounded border-dark-400 bg-dark-700 text-primary-500 focus:ring-primary-500"
              />
